...
public class dvExpandableListAdapter<T, U> extends BaseExpandableListAdapter {
 
    private Context _context;
    private List<T> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<T, List<U>> _listDataChild;
 
    public dvExpandableListAdapter(Context context, List<T> listDataHeader,
            HashMap<T, List<U>> listChildData) {
